...
interface DialogFromSchemaProps<Schema extends ZodObject<ZodRawShape>> {
  title?: string;
  schema: Schema;
...
export function DialogFromSchema<Schema extends ZodObject<ZodRawShape>>({
  title = "Create",
  schema,
  defaultValues,
  queryKey,
  submitFn,
}: DialogFromSchemaProps<Schema>) {
